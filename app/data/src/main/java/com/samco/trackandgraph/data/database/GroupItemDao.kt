...
internal interface GroupItemDao {
    ...
    @Query("UPDATE group_items_table SET display_index = display_index + 1 WHERE group_id = :groupId AND display_index > :afterIndex")
    fun shiftDisplayIndexesDownAfter(groupId: Long, afterIndex: Int)
