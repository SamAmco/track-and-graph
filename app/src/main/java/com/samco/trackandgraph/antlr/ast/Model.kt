...
fun Position.toPoint() = this.start
...
data class DatatransformationFunction(val statements : List<Statement>, override val position: Position? = null) :
    Node
...
data class UnaryMinusExpression(val value: Expression, override val position: Position? = null) :
    Expression
...
data class Assignment(val varName: String, val value: Expression, override val position: Position? = null) :
    Statement
