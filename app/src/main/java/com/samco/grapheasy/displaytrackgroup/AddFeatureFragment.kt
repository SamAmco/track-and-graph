...
import com.samco.grapheasy.databinding.AddFeatureFragmentBinding
import com.samco.grapheasy.databinding.FeatureDiscreteValueListItemBinding
    ...
    fun onAddFeature(activity: Activity, name: String, trackGroupId: Long) {
        ...
        uiScope.launch {
            ...
            withContext(Dispatchers.IO) {
                ...
                val feature = Feature(0, name, trackGroupId, featureType.value!!, discVals)
