...
object CSVReadWriter {
    ...
    private fun createNewFeature(dataSource: GraphEasyDatabaseDao, rec: RecordData, trackGroupId: Long, lineNumber: Int, validationCharacters: String): Feature {
    ...
    private fun tryAddDiscreteValueToFeature(dataSource: GraphEasyDatabaseDao, feature: Feature, discreteValue: DiscreteValue, lineNumber: Int): Feature {
