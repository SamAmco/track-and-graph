...
@HiltAndroidTest
class MainActivitySnapshotTest : ScreenshotTest {
    ...
    fun home_isStable() {
        ...
        activityRule.scenario.onActivity { activity ->
            compareScreenshot(activity = activity, name = "home")
        }
    }

    @Test
    fun home_with_drawer_isStable() {
        // Wait for app to fully load
        Thread.sleep(3000)
        ...
        activityRule.scenario.onActivity { activity ->
            compareScreenshot(activity = activity, name = "home_with_drawer")
        }
    }
}
