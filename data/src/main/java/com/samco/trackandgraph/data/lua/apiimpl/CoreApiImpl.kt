...
internal class CoreApiImpl @Inject constructor(
    ...
    private fun getTimeLuaFunction(): LuaValue =
    ...
    private fun getDateLuaFunction(): LuaValue =
        oneArgFunction { arg: LuaValue ->
    ...
    private fun getShiftLuaFunction(): LuaValue =
        threeArgFunction { arg1, arg2, arg3 ->
    ...
    private fun getFormatLuaFunction(): LuaValue =
        twoArgFunction { arg1, arg2 ->
            val dateTime = dateTimeParser.parseDateTimeOrNow(arg1)
