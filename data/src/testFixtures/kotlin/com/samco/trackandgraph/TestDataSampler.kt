...
object TestDataSampler {
    fun create(
        luaEngine: LuaEngine,
        dataInteractor: DataInteractor = TestDataInteractor.create(),
        database: TrackAndGraphDatabase = TestDatabase.create(),
    ): DataSampler = DataSamplerImpl(
